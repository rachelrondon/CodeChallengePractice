...
// find difference
function findDifference(array) {
  // define the largest as the first number witihn the array
  let largest = array[0];
  // define the smallest as the first number witihn the array
  let smallest = array[0];
...
// check to see if the string is in the form of a phone number


function validPhoneNumber(phoneNumber){
  var regEx = '^\s*(\d{3})\s*(\d{3})[-. ]*(\d{4})\s*$'
...
/* Find the largest number within an array with a for loop */
...
/* Simple array sum with a for loop */
...
/* Find the difference between the largest numbers within an array */
