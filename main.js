...
findLargestNumber([1,2,12,10,15])
...
// findDifference
// find the largest difference between two numbers within an array
...
//calculate which fraction of its elements are positive, negative, and zeros.

function plusMinus(size, array) {
  let positive = 0;
  let negative = 0;
  let zeros = 0;
